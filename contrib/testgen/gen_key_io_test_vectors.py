...
bech32_templates = [
  ...
  ('olc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('olc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('olc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tolc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tolc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tolc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rolc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rolc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rolc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tolc',  17, 32, False, False, False),
  ('rolc',  3,  1, False, False, False),
  ('olc',   15, 41, False, False, False),
  ('tolc',  0, 16, False, False, False),
  ('rolc',  0, 32, True,  False, False),
  ('olc',   0, 16, True,  False, False),
  ('tolc',  0, 32, False, True,  False),
  ('rolc',  0, 20, False, False, True)
]
