...
bech32_templates = [
  ...
  ('ovc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ovc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ovc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tovc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tovc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tovc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rovc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rovc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rovc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tovc',  17, 32, False, False, False),
  ('rovc',  3,  1, False, False, False),
  ('ovc',   15, 41, False, False, False),
  ('tovc',  0, 16, False, False, False),
  ('rovc',  0, 32, True,  False, False),
  ('ovc',   0, 16, True,  False, False),
  ('tovc',  0, 32, False, True,  False),
  ('rovc',  0, 20, False, False, True)
]
