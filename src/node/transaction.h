// Copyright (c) 2017-2019 The Olivingcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef OLIVINGCOIN_NODE_TRANSACTION_H
#define OLIVINGCOIN_NODE_TRANSACTION_H
...
#endif // OLIVINGCOIN_NODE_TRANSACTION_H
