    ...
    mapper(nullptr)
{
    ...
    ui->olivingcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->olivingcoinAtStartup);
    ...
    ui->olivingcoinAtStartup->setToolTip(ui->olivingcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->olivingcoinAtStartup->setText(ui->olivingcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openOlivingcoinConfButton->setToolTip(ui->openOlivingcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new OlivingcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->olivingcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openOlivingcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openOlivingcoinConf())
