    ...
    platformStyle(_platformStyle)
{
    ...
    // normal olivingcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying olivingcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &OlivingcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
