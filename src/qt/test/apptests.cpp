...
//! Entry point for OlivingcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OlivingcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OlivingcoinGUI tests.
void AppTests::guiTests(OlivingcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OlivingcoinGUI::consoleShown, this, &AppTests::consoleTests);
