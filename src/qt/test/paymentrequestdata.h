...
#ifndef OLIVINGCOIN_QT_TEST_PAYMENTREQUESTDATA_H
#define OLIVINGCOIN_QT_TEST_PAYMENTREQUESTDATA_H
...
//
// Payment request with amount overflow (amount is set to 84000001 OVC)
//
...
#endif // OLIVINGCOIN_QT_TEST_PAYMENTREQUESTDATA_H
