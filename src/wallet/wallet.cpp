        ...
        while (block_height && !fAbortRescan && !ShutdownRequested()) {
            ...
            if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
                ...
                if (!locked_chain->getBlockHeight(block_hash)) {
                    ...
                    // https://github.com/olivingcoin/olivingcoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-olivingcoin-address
 ...
 * https://olivingcointalk.org/?topic=54527, or
 * https://github.com/olivingcoin/olivingcoin/pull/1393.
 */
    ...
    if (tip_height && *tip_height != rescan_height)
    {
        ...
        if (fPruneMode)
        {
            ...
            if (rescan_height != block_height) {
                InitError(_("Prune: last wallet synchroniotsion goes beyond pruned data. You need to -reindex (download the whole blockchain again in case of pruned node)"));
                return nullptr;
            }
        }
