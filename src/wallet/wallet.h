...
#ifndef OLIVINGCOIN_WALLET_WALLET_H
#define OLIVINGCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! olivingcoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this olivingcoin node, and set to 0 for transactions that were created
...
#endif // OLIVINGCOIN_WALLET_WALLET_H
