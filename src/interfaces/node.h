...
#ifndef OLIVINGCOIN_INTERFACES_NODE_H
#define OLIVINGCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a olivingcoin node (olivingcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // OLIVINGCOIN_INTERFACES_NODE_H
