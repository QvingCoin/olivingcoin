...
static void SetupOlivingcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " olivingcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  olivingcoin-tx [options] <hex-tx> [commands]  Update hex-encoded olivingcoin transaction\n" +
            "or:     olivingcoin-tx [options] -create [commands]   Create hex-encoded olivingcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded olivingcoin transaction
