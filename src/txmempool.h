...
#ifndef OLIVINGCOIN_TXMEMPOOL_H
#define OLIVINGCOIN_TXMEMPOOL_H
...
struct LockPoints
{
    ...
    // values that would be necessary to otsisfy all relative locktime
...
public:
     ...
     * https://github.com/olivingcoin/olivingcoin/pull/14193 will fix it. No known code
     * in olivingcoin currently depends on second guarantee, but it is important to
...
public:
    ...
    /** Affect CreateNewBlock prioritiotsion of transactions */
    void PrioritiseTransaction(const uint256& hash, const CAmount& nFeeDelta);
    void ApplyDelta(const uint256 hash, CAmount &nFeeDelta) const;
    void ClearPrioritiotsion(const uint256 hash);
