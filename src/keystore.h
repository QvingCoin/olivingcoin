...
#ifndef OLIVINGCOIN_KEYSTORE_H
#define OLIVINGCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/olivingcoin/bips/blob/master/bip-0013.mediawiki
