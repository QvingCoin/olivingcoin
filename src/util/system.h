 ...
 */
#ifndef OLIVINGCOIN_UTIL_SYSTEM_H
#define OLIVINGCOIN_UTIL_SYSTEM_H
...
extern const char * const OLIVINGCOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("olivingcoin-%s", name);
...
#endif // OLIVINGCOIN_UTIL_SYSTEM_H
