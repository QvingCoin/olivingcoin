...
#ifndef OLIVINGCOIN_TEST_SCRIPTNUM10_H
#define OLIVINGCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Olivingcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // OLIVINGCOIN_TEST_BIGNUM_H
