...
{
    BOOST_CHECK(TestSplitHost("www.olivingcoincore.org", "www.olivingcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.olivingcoincore.org]", "www.olivingcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.olivingcoincore.org:80", "www.olivingcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.olivingcoincore.org]:80", "www.olivingcoincore.org", 80));
