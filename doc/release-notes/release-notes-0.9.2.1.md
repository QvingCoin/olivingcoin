Olivingcoin Core version 0.9.2.1 is now available from:

  https://olivingcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OVC to 0.01 OVC
...
- Fix "Start olivingcoin on system login"
