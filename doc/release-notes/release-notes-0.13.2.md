Olivingcoin Core version 0.13.2 is now available from:
  ...
  <https://olivingcoin.org/bin/olivingcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update olivingcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow olivingcoin-tx to create v2 transactions (olcdrak)
