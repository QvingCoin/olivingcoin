Olivingcoin Core version *0.14.3* is now available from:

  <https://olivingcoin.org/bin/olivingcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/olivingcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
