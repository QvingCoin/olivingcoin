Olivingcoin Core version *0.15.2* is now available from:

  <https://olivingcoincore.org/bin/olivingcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in olivingcoin-tx (TheBlueMatt)
