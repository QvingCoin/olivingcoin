Olivingcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/olivingcoin/files/Olivingcoin/olivingcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Olivingcoin
...
New/changed settings (command-line or olivingcoin.conf file)
--------------------------------------------------------
