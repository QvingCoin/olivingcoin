Olivingcoin Core version 0.10.4 is now available from:

  <https://olivingcoin.org/bin/olivingcoin-core-0.10.4/>
...
- #6953 `43c2789` Split olivingcoin-tx into its own package
- #6953 `dfe0d4d` Include olivingcoin-tx binary on Debian/Ubuntu
