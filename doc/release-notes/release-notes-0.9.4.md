Olivingcoin Core version 0.9.4 is now available from:

  https://olivingcoin.org/bin/0.9.4/
...
this update is incompatible with the Olivingcoin system and could lead to consensus
forks.

Olivingcoin Core released binaries from https://olivingcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~olivingcoin/+archive/ubuntu/olivingcoin
- A third-party or self-compiled Olivingcoin Core

upgrade to Olivingcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
