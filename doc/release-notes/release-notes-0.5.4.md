Olivingcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/olivingcoin/files/Olivingcoin/olivingcoin-0.5.4/
...
http://gitorious.org/olivingcoin/olivingcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Olivingcoin-Qt notifications under Growl 1.3.
Increase required age of Olivingcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOlivingcoin properly when installing Olivingcoin-Qt over it. (Windows)
