...
This document provides guidelines for internationalization of the Olivingcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `olivingcoin_en.ts` remains unchanged.
