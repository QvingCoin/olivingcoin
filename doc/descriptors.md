...
- Segwit addresses (bech32, of the form `olc1...` for mainnet or `tolc1...` for testnet, defined in [BIP 173](https://github.com/olivingcoin/bips/blob/master/bip-0173.mediawiki)).
