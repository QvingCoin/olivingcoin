...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/olivingcoin-project/gitian.sigs.olc.git
...
Ensure your gitian.sigs.olc are up-to-date if you wish to gverify your builds against other Gitian signatures.

    pushd ./gitian.sigs.olc
    git pull
    popd
...
### Build and sign Olivingcoin Core for Linux, Windows, and macOS:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-linux --destination ../gitian.sigs.olc/ ../olivingcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-unsigned --destination ../gitian.sigs.olc/ ../olivingcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.olc/ ../olivingcoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  5. Gitian signatures (in `gitian.sigs.olc/${VERSION}-<linux|{win,osx}-unsigned>/(your Gitian key)/`)
...
Verify the signatures
    ...
    pushd ./gitian-builder
    ./bin/gverify -v -d ../gitian.sigs.olc/ -r ${VERSION}-linux ../olivingcoin/contrib/gitian-descriptors/gitian-linux.yml
    ./bin/gverify -v -d ../gitian.sigs.olc/ -r ${VERSION}-win-unsigned ../olivingcoin/contrib/gitian-descriptors/gitian-win.yml
    ./bin/gverify -v -d ../gitian.sigs.olc/ -r ${VERSION}-osx-unsigned ../olivingcoin/contrib/gitian-descriptors/gitian-osx.yml
    popd

### Next steps:

Commit your signature to gitian.sigs.olc:
...
Create (and optionally verify) the signed macOS binary:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-signed --destination ../gitian.sigs.olc/ ../olivingcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.olc/ -r ${VERSION}-osx-signed ../olivingcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-signed --destination ../gitian.sigs.olc/ ../olivingcoin/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.olc/ -r ${VERSION}-win-signed ../olivingcoin/contrib/gitian-descriptors/gitian-win-signer.yml
...
Commit your signature for the signed macOS/Windows binaries:
    ...
    git commit -a
    git push  # Assuming you can push to the gitian.sigs.olc tree
    popd
...
space *do not upload these to the olivingcoin.org server, nor put them in the torrent*.
