Olivingcoin Core version 0.16.2 is now available from:

  <https://download.olivingcoin.org/olivingcoin-0.16.2/>
...
- #12843 `df38b13` Test starting olivingcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure olivingcoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` olivingcoinconsensus: invalid flags should be set to olivingcoinconsensus_error type, add test cases covering olivingcoinconsensus error codes (Thomas Kerin)
