...
### BIP173 (Bech32) Address support ("olc1..." addresses)
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("olc1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
...
- #12035 `eeb6d52` Change µOLC to bits (jb55)
