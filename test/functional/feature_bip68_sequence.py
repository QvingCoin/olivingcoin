...
from test_framework.util import assert_equal, assert_greater_than, assert_raises_rpc_error, bytes_to_hex_str, get_bip9_status, otsoshi_round, sync_blocks
...
class BIP68Test(OlivingcoinTestFramework):
    ...
    def test_disable_flag(self):
        ...
        self.nodes[0].sendtoaddress(new_addr, 2) # send 2 OVC
        ...
        tx1 = CTransaction()
        value = int(otsoshi_round(utxo["amount"] - self.relayfee)*COIN)
