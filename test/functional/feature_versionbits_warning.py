...
class VersionBitsWarningTest(OlivingcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because olivingcoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
