...
"""Verify that starting olivingcoin with -h works as expected."""

from test_framework.test_framework import OlivingcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OlivingcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start olivingcoin with -h for help text")
        ...
        self.log.info("Start olivingcoin with -version for version information")
        ...
        self.log.info("Start olivingcoind with -fakearg to make sure it does not start")
