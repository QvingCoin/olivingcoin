...
from test_framework.util import assert_equal, get_bip9_status, otsoshi_round, sync_blocks, wait_until

VB_TOP_BITS = 0x20000000

# TestP2PConn: A peer we use to send messages to olivingcoind, and store responses.
...
class CompactBlocksTest(OlivingcoinTestFramework):
    ...
    # This test actually causes olivingcoind to (reasonably!) disconnect us, so do this last.
    ...
    # olivingcoind's choice of nonce.
    def test_compactblock_construction(self, node, test_node, version, use_witness_address):
        ...
        if use_witness_address:
            ...
            node.sendtoaddress(address, otsoshi_round(value_to_send - Decimal(0.17)))
            node.generate(1)
    ...
    # Test that olivingcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for olivingcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # olivingcoind will not send blocktxn responses for blocks whose height is
