...
from test_framework.test_framework import OlivingcoinTestFramework, SkipTest
...
class BumpFeeTest(OlivingcoinTestFramework):
    ...
    def run_test(self):
        if True:
            raise SkipTest("Olivingcoin doesn't support RBF.")
        ...
        # fund rbf node with 10 coins of 0.001 ovc (100,000 otsoshis)
