...
class ImportMultiTest(OlivingcoinTestFramework):
    ...
    def run_test(self):
        ...
        addresses = [
            'rolc1qtmp74ayg7p24uslctssvjm06q5phz4yrc3zpyj', # m/0'/0'/0
            'rolc1q8vprchan07gzagd5e6v9wd7azyucksq2c4ynpe', # m/0'/0'/1
            'rolc1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjlg94gz', # m/0'/0'/2
            'rolc1qau64272ymawq26t90md6an0ps99qkrse22pnz3', # m/0'/0'/3
            'rolc1qsg97266hrh6cpmutqen8s4s962aryy77vv4ql3', # m/0'/0'/4
        ]
        result = wrpc.importmulti(
            [{
