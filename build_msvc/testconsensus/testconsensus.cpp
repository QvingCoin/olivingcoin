...
// olivingcoin includes.
#include <..\src\script\olivingcoinconsensus.h>
...
int main()
{
    std::cout << "olivingcoinconsensus version: " << olivingcoinconsensus_version() << std::endl;
    ...
    auto op0Result = olivingcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, olivingcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
